                                    ...
                                    <form action="/sys/user/user!userList.do" method="post" class="form form-search" id="J_SearchForm">
                                        <div class="form-group form-grid form-group-search form-group-search-user-list">
							                <ul class="list-inline list-autowidth">
							                    <li class="form-item">
								                     <label class="form-label" for="startTime"><span class="langbox">访问时间</span><span class="langbox" data-lang="commonColon"></span></label>
...
<script>
    (function () {
    	...
    	var $dataGrid = $('#J_DataGrid'),
			postUrl = "/androidManager/log!deviceAccessLogList.do",
			postData = null;
	    ...
	    function setDataGrid(queryURL, queryData) {
			var setting = {
				...
				columns:[[
	                ...
	                { field: 'opName', title: '操作类型', width: 50 },
	                { field: 'result', title: '操作结果', width: 200 },
	                { field: 'createTime', title: '访问时间', width: 70, align: 'center' }
				]]
			};
