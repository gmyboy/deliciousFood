                                    ...
                                    <form action="/sys/user/user!userList.do" method="post" class="form form-search" id="J_SearchForm">
                                        <div class="form-group form-grid form-group-search form-group-search-user-list">
							                <ul class="list-inline list-autowidth">
							                    <li class="form-item">
								                     <label class="form-label" for="startTime"><span class="langbox">创建时间</span><span class="langbox" data-lang="commonColon"></span></label>
...
<script>
    (function () {
    	...
    	var $dataGrid = $('#J_DataGrid'),
			postUrl = "/androidManager/log!upgradeResultLogList.do",
			postData = null;
	    ...
	    function setDataGrid(queryURL, queryData) {
			var setting = {
				...
				sortOrder:"desc",
				columns:[[
	                { field: 'terminalId', title: '终端Id', width: 100 },  
	                { field: 'merchants', title: '商家', width: 100 },
	                { field: 'version', title: '版本号', width: 100 },
	                { field: 'upgradeResult', title: '升级结果', width: 100 },
	                { field: 'createTime', title: '访问时间', width: 100, align: 'center' }
				]]
			};
